import RootMenuDashboard from "../../../admin/components/RootMenuDashboard";
import ProfessionalMenuDashboard from "../../../professional/components/dashboard/ProfessionalMenuDashboard";
...
function DashboardLayout({ children }) {
  ...
  return (
    <section className="dashboard-layout_container">
      {/* Contexto de ambos dashboards, para seleccionar una opcion del menu */}
      <DashboardProvider>
