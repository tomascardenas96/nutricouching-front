...
const ViandsCardDashboard = memo(function ViandsCardDashboard({
  viand,
  openEditViandModal,
  openDeleteViandModal,
}) {
  return (
    <tr className="dashboard_viand-item">
      ...
      <td className="options-row">
        ...
        <p className="delete" onClick={() => openDeleteViandModal(viand.viandId)}>
          Eliminar
        </p>
      </td>
    </tr>
