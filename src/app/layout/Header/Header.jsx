...
function Header({
  ...
  const quantityOfProductsInCart = useMemo(() => {
    ...
    const productsQuantity = productsInCart.reduce((acc, p) => acc + p.quantity, 0);
  ...
  return (
    ...
    <div className={`header-wrapper${isStuck ? " header-wrapper--stuck" : ""}${isExiting ? " header-wrapper--exiting" : ""}`}>
      {/* Topbar */}
      <div className="header-topbar">
        ...
        <div className="header-topbar__contact">
          <span><MdOutlinePhone /> +549 2281-332211</span>
          <span><MdOutlineEmail /> administracion@cohesiva.com</span>
        </div>
      </div>

      {/* Main header */}
      <div className={`header${scrolled ? " header--scrolled" : ""}`} id="main-page">
        ...
        <nav className="header-menu">
          <ul>
            ...
            <li><a href="/#viands">Viandas</a></li>
            <li><Link to="/filter/professionals">Profesionales</Link></li>
